...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create vutabase-7080
  fly apps create vutabase-7080-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app vutabase-7080
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app vutabase-7080-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'vutabase-7080-staging' does not match app name in config file 'vutabase-7080'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name vutabase-7080-db
  fly postgres attach --app vutabase-7080 vutabase-7080-db

  fly postgres create --name vutabase-7080-staging-db
  fly postgres attach --app vutabase-7080-staging vutabase-7080-staging-db
  ```
